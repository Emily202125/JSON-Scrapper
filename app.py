...
if st.button("Submit"):
    try:
        ...
        conn = http.client.HTTPSConnection("linkedin-profile-and-company-data-api.p.rapidapi.com")

        headers = {
            'x-rapidapi-key': "e6274d5593msh7a4e71bb2fe2f44p1552bejsn76fc9770b557",  # Replace with your real key
            'x-rapidapi-host': "linkedin-profile-and-company-data-api.p.rapidapi.com"
        }
